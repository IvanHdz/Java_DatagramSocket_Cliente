...
public class VentanaCliente extends javax.swing.JFrame {
    ...
    public VentanaCliente() {
        ...
        try {
            socket = new DatagramSocket(63160); //Puerto del cliente
    ...
    private void initComponents() {
        ...
        jTextAreaCliente.setBorder(null);
        ...
        jLabel1.setText("Servidor (Disponible)");
    ...
    private void jTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField1ActionPerformed
        try {
            ...
            DatagramPacket enviarPaquete = new DatagramPacket(datos,
                    datos.length, InetAddress.getLocalHost(), 5000); //Puerto del servidor

            socket.send(enviarPaquete);

            jTextAreaCliente.setCaretPosition(
                    jTextAreaCliente.getText().length());
            jTextField1.setText("");
    ...
    public void esperarPaquetesServidor() {
        while (true) {
            try {
    ...
    private void mostrarMensaje(final String mensajeAMostrar) {
        SwingUtilities.invokeLater(
            ...
            @Override
            public void run() {
                jTextAreaCliente.append(mensajeAMostrar);
                jTextAreaCliente.setCaretPosition(
                        jTextAreaCliente.getText().length());
            }
        });
